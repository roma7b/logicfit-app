...
const AIChat: React.FC<AIChatProps> = ({ userName, onBack }) => {
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    // CORREÇÃO: Filtrar a mensagem de introdução ('intro') para que o histórico
    // enviado para a API comece corretamente (ou esteja vazio se for a primeira msg).
    // O Gemini exige que o histórico comece com 'user' ou esteja vazio (já que o prompt atual é 'user').
    ...
    try {
      ...
      const responseText = data.text || "Não consegui formular uma resposta no momento. Tente novamente.";
